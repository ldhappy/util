...
public class MapParse<R> extends AbstractParse<Map,R>{
    ...
    public void parse() {
        ...
        try {
            ...
            throw new ParseException(getErrorMessage(TransitionMessageSource.CREATE_RULE_EXCEPTION)+e.getMessage());
    ...
    private void convert() throws InstantiationException, IllegalAccessException {
        if(convert != null){
            ...
            throw new ParseException(getErrorMessage(TransitionMessageSource.MUST_CONVERT));
        }
    }
    ...
    private void validate() throws IllegalAccessException, InstantiationException {
        ...
        if(validate != null){
            ...
            throw new ParseException(getErrorMessage(TransitionMessageSource.MUST_VALIDATE));
        }
    }
